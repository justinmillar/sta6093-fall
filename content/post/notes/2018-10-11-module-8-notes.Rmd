...
#### [Download notes as a PDF](https://sta6093.netlify.com/pdf/2018-10-1-module-8-notes.pdf)
...
Again, as we dicussed earlier we're looking for patterns, and it will typically be easier to tell of something is heteroscedastic than so be sure that it is homoscedastic. One real-world example of heteroscedastic data could be height as a function of age. Height typicaly increases as age increase (up to a certain), however there is a larger degree of variance in age-specific height during the pubescent years than outside this age range. I looked all over for some actual data to show this but couldn't find any, if you find some email me and I'll update this page.
